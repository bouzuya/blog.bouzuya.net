...
- [x] bouzuya/purescript-npm-bin-google-tasks 0.2.0 をつくる
- [x] AtCoder Beginner Contest に参加する
- [x] 2019-03 ふりかえりを書く
- [x] bouzuya/yzrh 0.1.0 をつくる
- [x] AtCoder 過去問題を毎日解く
...
- [x] CoffeeScript & JavaScript リポジトリを廃止する
- [x] mockmock.dev w010 で PureScript を使用する
- [x] AtCoder の問題に挑戦する
- [x] 週に 1 冊は本を読む
- [x] 毎日の計画・ふりかえりをする
